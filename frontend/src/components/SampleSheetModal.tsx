      ...
      <div className="bg-surface-800 rounded-2xl border border-slate-600 shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30 text-blue-200 text-sm">
            ...
            <p>Create a new sheet at <a href="https://sheets.new" target="_blank" rel="noopener noreferrer" className="underline">sheets.new</a>, add a tab named &quot;Stocks&quot;, then copy the format below. Sample CSV files are in the <code className="bg-slate-700 px-1 rounded">sample-sheet/</code> folder of this project.</p>
          </div>
